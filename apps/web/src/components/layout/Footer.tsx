      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-extrabold text-2xl tracking-tight leading-none select-none">
                <span className="text-white">Penjaga</span>{" "}
                <span className="text-red-400">Hati</span>
              </span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Platform penyedia jasa pendamping pasien profesional di rumah sakit. Kami memberikan ketenangan bagi keluarga dan pendampingan optimal bagi pasien.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="https://wa.me/6285172081518?text=Halo%20Penjaga%20Hati,%20saya%20tertarik%20untuk%20bergabung%20sebagai%20mitra%20pendamping." target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white text-sm transition-colors">Karir Mitra</a></li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Penjaga Hati. Hak Cipta Dilindungi.
          </p>
